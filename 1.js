        ...
        n = function (n) {
          ...
          ; (this.resize = function () {
            ...
            (this.flash = function () {
              ...
              for (var n = 0; n < 3; n += 2)
                TweenLite.delayedCall(0.07 * n, a),
                  TweenLite.delayedCall(0.07 * (n + 1), e)
            }),
              ...
              (function () {
                ...
                for (var t = 360 / p, i = 0; i < p; i++) {
                  var o = (i * t * Math.PI) / 180,
                    ...
                    ; (M['p' + i] = { x: r, y: l }),
                      TweenLite.to(M['p' + i], 0.6, { x: s, y: d })
                }
                ; (M.progress = 0),
                  TweenLite.to(M, 0.8, {
                    progress: 1,
